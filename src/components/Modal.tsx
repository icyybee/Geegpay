...
const ModalBox: React.FC<ModalBoxProps> = ({children, isModalOpen, setIsModalOpen}) => {
    ...
    return (
        <Modal 
            ...
            centered
            footer={[
                <button className={`border ${isDarkMode && 'border-[#262626]'} p-2 rounded-lg`} onClick={handleCancel}>
                  Cancel
                </button>,
                <button className={`border ${isDarkMode && 'border-[#262626]'} p-2 rounded-lg flex items-center gap-1`} onClick={handleCancel}>
